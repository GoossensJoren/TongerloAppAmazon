...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("<div class=\"container\">\n  <p class=\"title\">Tongerlo Leeft!</p>\n  <p>In 1987 werd “Tongels Dorpsfeest\" opgericht door Jan Michiels, die samen met Erik van Eynde en Willy Van Eysendeyk\n    -allen actief in het verenigingsleven- een nieuw openluchtfeest wilden organiseren. Dit ter vervanging van de ter\n    ziele gegane lichtstoet in de jaren 60.</p>\n  <p>Sinds vele jaren wordt het “Tongels Dorpsfeest” georganiseerd door ‘Tongerlo Leeft’ : een groep van tien echte\n    Tongelse verenigingen.</p>\n  <p>Het zijn deze sport-, culturele en jeugdverenigingen die telkens 2 personen afvaardigen op de maandelijkse\n    vergaderingen en die beslissen over het concept en de organisatie van het dorpsfeest.</p>\n  <p>Ook de samenwerking met onze lokale en regionale sponsors blijft een onmiskenbaar gegeven om sociale consumptie-en\n    toegangsprijzen samen met een sfeervol programma mogelijk te maken.</p>\n  <p class=\"title\">DEELNEMENDE VERENGINGEN</p>\n  <p>Organisatiecomité met deelnemende Tongelse verenigingen voor het 37e Tongels Dorpsfeest op vrijdag 10, zaterdag 11 en zondag 12 mei 2024:</p>\n  <mat-list [@listStagger]='groups.length' class=\"groups\">\n    <mat-list-item *ngFor=\"let group of groups; let i = index \" class=\"group\">\n      <i class=\"material-icons\">\n        play_arrow\n      </i>\n      <a href=\"{{group.link}}\" (mouseover)=\"toggle(i)\" (mouseleave)=\"toggle(i)\">{{group.name}}</a>\n      <p class=\"link\" [@popOverState]=\"stateName(i)\">->{{group.link | stringlimit}}</p>\n    </mat-list-item>\n  </mat-list>\n</div>");
...
let HomeComponent = class HomeComponent {
    ...
    onExpand1() {
        this.opened = 1;
        let height = window.innerWidth / 2 + 1000;
        this.margin = height + "px";
    }
    onExpand2() {
        this.opened = 2;
        let height = window.innerWidth * 3 + 2900;
        this.margin = height + "px";
    }
    onExpand3() {
        this.opened = 3;
